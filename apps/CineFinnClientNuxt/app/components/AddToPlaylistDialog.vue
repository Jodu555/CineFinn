<template>
    <div>
        ...
        <div>
            <slot name="trigger">
                <button class="btn bg-transparent" :class="['btn-' + openButtonColor]" @click="open = true">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-else>
                            <div class="mb-3">
                                ...
                                <input id="playlist-name" v-model="newPlaylistName" type="text" class="form-control"
...
await callOnce('playlists', () => playlistStore.loadPlaylists());
