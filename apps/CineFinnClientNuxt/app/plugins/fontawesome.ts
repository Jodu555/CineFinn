...
import {
    ...
    faClock as fasClock, faUpLong, faPenRuler, faSitemap,
...
library.add(
    ...
    faFire, faBookmark, faMinus, faTowerBroadcast, faBell, faArrowRotateLeft, fasClock, faUpLong, faGrip, faPenRuler, faSitemap
);
