...
import {
    ...
    faClock as fasClock, faUpLong, faPenRuler, faSitemap, faSpinner,
...
library.add(
    ...
    faFire, faBookmark, faMinus, faTowerBroadcast, faBell, faArrowRotateLeft, fasClock, faUpLong, faGrip, faPenRuler, faSitemap, faSpinner
);
