<template>
    <div class="min-vh-100">
                                ...
                                <div class="d-flex align-items-start justify-content-between">
                                    ...
                                    <div class="d-flex gap-1 ms-2">
                                        <button class="btn btn-sm btn-link text-secondary p-1"
                                            @click.stop="editingPlaylist = { ...playlist }">
                                ...
                                <div class="card border-0 shadow-sm position-relative playlist-item-card">
                                    <div class="position-relative overflow-hidden rounded">
                                        <img :src="item.cover || '/placeholder.svg'" :alt="item.title"
                                            class="card-img-top" style="aspect-ratio: 230/346; object-fit: cover" />
                                        <div
        ...
        <div class="modal fade" :class="{ show: createDialogOpen, 'd-block': createDialogOpen }" tabindex="-1"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div>
                            ...
                            <p class="text-muted small mb-0">Create a custom playlist to organize your favorite content
                            </p>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input id="new-playlist-name" v-model="newPlaylistName" type="text" class="form-control"
                                placeholder="My Awesome Playlist" />
                        </div>
                        <div class="mb-3">
                            <label for="new-playlist-description" class="form-label">Description (Optional)</label>
                            <textarea id="new-playlist-description" v-model="newPlaylistDescription"
                                class="form-control" rows="3"
                                placeholder="A collection of my favorite shows..."></textarea>
                        </div>
                        <button class="btn btn-primary w-100" :disabled="!newPlaylistName.trim()"
        ...
        <!-- Edit Playlist Modal -->
        <div class="modal fade" :class="{ show: !!editingPlaylist, 'd-block': !!editingPlaylist }" tabindex="-1"
            @click.self="editingPlaylist = null">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" v-if="editingPlaylist">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input id="edit-playlist-name" v-model="editingPlaylist.name" type="text"
                                class="form-control" />
                        </div>
                        <div class="mb-3">
                            <label for="edit-playlist-description" class="form-label">Description</label>
                            <textarea id="edit-playlist-description" v-model="editingPlaylist.description"
                                class="form-control" rows="3"></textarea>
                        </div>
                        <button class="btn btn-primary w-100" :disabled="!editingPlaylist.name.trim()"
        ...
        <div class="modal fade" :class="{ show: !!deletePlaylistId, 'd-block': !!deletePlaylistId }" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-muted">
                            This action cannot be undone. This will permanently delete your playlist and remove all
                            items from it.
                        </p>
                    </div>
        ...
        <!-- Modal Backdrop -->
        <div v-if="createDialogOpen || editingPlaylist || deletePlaylistId" class="modal-backdrop fade show"
