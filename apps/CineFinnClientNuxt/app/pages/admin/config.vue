							...
							<div class="card-body">
								<ul class="list-group list-group-flush bg-transparent">
									<ConfigItem
										...
										updateKey="config.database.host"
										icon="server"
										:editable="true"
										@update="handleUpdate"
									/>
									<ConfigItem label="Database" :value="config.database.database" updateKey="config.database.database" icon="table" />
									<ConfigItem
										label="Username"
										:value="config.database.username"
										updateKey="config.database.username"
										icon="user"
										:editable="true"
										@update="handleUpdate"
									/>
									<ConfigItem label="Password" :value="config.database.password" updateKey="config.database.password" icon="lock" is-sensitive />
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="card-body">
								<ul class="list-group list-group-flush bg-transparent">
									...
									<ConfigItem
										...
										updateKey="config.redis.password"
										icon="key"
										is-sensitive
										:editable="true"
										@update="handleUpdate"
				...
				<div class="card h-100 bg-body-tertiary border-secondary shadow-sm">
					...
					<div class="card-body">
						<ul class="list-group list-group-flush bg-transparent">
							...
							<ConfigItem label="Secure" :value="config.smtp.secure" type="boolean" icon="shield-halved" />
							<!-- User had weird wrapping, editable helps alignment -->
							<ConfigItem label="User" :value="config.smtp.auth.user" updateKey="config.smtp.auth.user" @update="handleUpdate" />
					...
					<div class="card-body">
						<ul class="list-group list-group-flush bg-transparent">
							<ConfigItem
								...
								:value="config.system.PUBLIC_API_AUTH_TOKEN"
								updateKey="config.system.PUBLIC_API_AUTH_TOKEN"
								is-sensitive
								:editable="true"
								@update="handleUpdate"
							/>
							<ConfigItem
								label="Scraper Token"
								:value="config.scraper.authToken"
								is-sensitive
								updateKey="config.scraper.authToken"
								:editable="true"
								@update="handleUpdate"
							/>
							<ConfigItem
								label="Subsystem Token"
								:value="config.subsystem.authToken"
								is-sensitive
								updateKey="config.subsystem.authToken"
								:editable="true"
								@update="handleUpdate"
							/>
					...
					<div class="card-body">
						<ul class="list-group list-group-flush bg-transparent">
							<ConfigItem
								...
								type="boolean"
								updateKey="config.registration.enabled"
								icon="toggle-on"
								:editable="true"
								@update="handleUpdate"
							/>
							<ConfigItem
								label="Token"
								:value="config.registration.token"
								updateKey="config.registration.token"
								is-sensitive
								:editable="true"
								@update="handleUpdate"
							/>
			...
			<div class="col-12">
				<div class="card bg-body-tertiary border-secondary shadow-sm">
					...
					<div class="card-body">
						<div class="row">
							<div class="col-md-6">
								...
								<ul class="list-group list-group-flush bg-transparent">
									<ConfigItem
										label="Tracking URL"
										:value="config.proxyAPIs.segmentapi.url"
										updateKey="config.proxyAPIs.segmentapi.url"
										icon="chart-line"
										:editable="true"
										@update="handleUpdate"
									/>
							...
							<div class="col-md-6">
								...
								<ul class="list-group list-group-flush bg-transparent">
									<ConfigItem
										label="API URL"
										:value="config.proxyAPIs.anidbapi.url"
										icon="tv"
										updateKey="config.proxyAPIs.anidbapi.url"
										:editable="true"
										@update="handleUpdate"
									/>
								</ul>
						...
						<div class="row mt-4">
							<div class="col-md-5">
								<h6 class="text-uppercase text-muted fs-7 mb-3">Bullboard API</h6>
								<ul class="list-group list-group-flush bg-transparent">
									<ConfigItem
										label="Tracking URL"
										:value="config.proxyAPIs.bullboardapi.url"
										updateKey="config.proxyAPIs.bullboardapi.url"
										icon="chart-line"
										:editable="true"
										@update="handleUpdate"
									/>
							...
							<div class="col-md-3">
								<h6 class="text-uppercase text-muted fs-7 mb-3">Bullboard API Token</h6>
								<ul class="list-group list-group-flush bg-transparent">
									<ConfigItem
										label="API Token"
										:value="config.proxyAPIs.bullboardapi.apiToken"
										updateKey="config.proxyAPIs.bullboardapi.apiToken"
										icon="chart-line"
										is-sensitive
										:editable="true"
										@update="handleUpdate"
