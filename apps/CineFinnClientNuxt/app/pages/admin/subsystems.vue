<template>
    <div>
        ...
        <div class="d-flex justify-content-center">
            <button type="button" class="btn btn-outline-primary me-4">Add
                Item</button>
            ...
            <button type="button" class="btn btn-outline-danger" @click="adminStore.removeAdditionalItems()">Remove
                Additional
                Items</button>
        </div>
        <hr>
        <div v-auto-animate v-for="item in adminStore.movingItems" :key="item.ID" class="row">
            <div class="col-auto ms-5 me-auto">
                ...
                <div class="d-flex gap-3 mb-2">
                    <button v-if="item.meta.movingStarted == 0" @click="adminStore.moveItem(item.ID)" type="button"
