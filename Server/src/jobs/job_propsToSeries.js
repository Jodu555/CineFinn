...
module.exports = {
    ...
    help: {
        description: 'This recieves an input file with a list of series and converts it into the new series model and saves it to the output file based on the model file which describes the new series object',
