<template>
	<div class="container" v-auto-animate>
				...
				<li class="list-group-item" v-auto-animate>
					<div class="d-flex" v-auto-animate>
						...
						<div style="width: 100%" v-auto-animate>
							...
							<div v-if="auth.userInfo.role > 2" style="width: 15%" class="d-flex justify-content-around">
							...
							<ul v-if="!minimal && languageDevision(element).total != -1">
								...
								<li v-if="auth.userInfo.role > 1">
									<em>
										...
										<br />
										<p v-if="auth.userInfo.role > 1" style="cursor: pointer"
		...
		<div v-if="state.list.length >= 7" class="d-flex justify-content-between mt-5 mb-5">
			...
			<button v-if="auth.userInfo.role >= 2" class="btn btn-outline-danger mb-5"
				@click="rescrapeAllItems">Rescrape All
				Items</button>
		</div>
